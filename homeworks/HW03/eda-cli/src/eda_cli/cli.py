...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть ли колонки с одинаковыми значениями: **{quality_flags['has_constant_columns']}**\n")
        f.write(f"- Есть повторяющиеся id: **{quality_flags['has_suspicious_id_duplicates']}**\n\n")
        ...
        if not top_cats:
            ...
            f.write(f"См. файлы с топ-{top_k_categories} категориями в папке `top_categories/`.\n\n")
